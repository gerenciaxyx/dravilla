        ...
        if ( $this->utils->isThisPage( 'wp-admin/admin.php?page=hostinger-get-onboarding' ) || $this->utils->isThisPage( 'wp-admin/admin.php?page=' . Menus::MENU_SLUG ) ) {
            ...
            $localize_data = array(
                ...
                'translations' => array(
                    ...
                    'hostinger_easy_onboarding_welcome_to_wordpress' => __( 'Website is published', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_store_info' => __( 'Store info', 'hostinger-easy-onboarding' ),
                    ...
                    'hostinger_easy_onboarding_welcome_to_woocommerce_title' => __( '👋 Welcome to WooCommerce', 'hostinger-easy-onboarding' ),
                    'hostinger_easy_onboarding_welcome_to_woocommerce_description' => __( 'Set up a website that works for you.', 'hostinger-easy-onboarding' ),
                ...
                // 'ajax_nonce'         => wp_create_nonce( 'hts-ajax-nonce' ),
